...
-This project is a small Library Management System made in Python. It works with simple text files and runs in the command line. We can add, search, update, delete, issue, and return books easily. Two text files are used for storing information:
-library.txt – keeps book details like Book ID, Title, Author, and Quantity
-issued_books.txt – keeps issued book details like Book ID, Title, Student Name, Student ID, Issue Date, and Due Date
-This project is mainly for learning and small demonstrations. It does not need any extra software and runs only with Python 3.

## Files in this repository

-library new and final.py – this is the main Python program. We run this file to open the menu and use the library system.
-library.txt – this file stores all the available books. Each line has the details in this format:
BookID, Title, Author, Quantity
-issued_books.txt – this file stores the books that have been issued. Each line has:
BookID, Title, StudentName, StudentID, IssueDate, DueDate
-issued_books.txt – this file can be empty in the beginning because no books are issued at first.
